...
public interface GravatarImageRequest {
     ...
     * @return this builder
     */
    GravatarImageRequest setShouldAppendJpgSuffix(boolean shouldAppendJpgSuffix);
     ...
     * @return this builder
     */
    GravatarImageRequest setSize(int size);
     ...
     * @return this builder
     */
    GravatarImageRequest setRatings(Collection<GravatarRating> ratings);
     ...
     * @return this builder
     */
    GravatarImageRequest setRating(GravatarRating rating);
     ...
     * @return this builder
     */
    GravatarImageRequest addRatings(Collection<GravatarRating> ratings);
     ...
     * @return this builder
     */
    GravatarImageRequest addRating(GravatarRating rating);
     ...
     * @return this builder
     */
    GravatarImageRequest setForceDefaultImage(boolean forceDefaultImage);
     ...
     * @return this builder
     */
    GravatarImageRequest setDefaultImageType(GravatarDefaultImageType defaultImageType);
     ...
     * @return this builder
     */
    GravatarImageRequest setDefaultImageUrl(String defaultImageUrl);
     ...
     * @return this builder
     */
    GravatarImageRequest setUseHttps(boolean useHttps);
     ...
     * @return this builder
     */
    GravatarImageRequestBuilder setUseFullUrlParameterNames(boolean useFullUrlParameterNames);
